  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title col-m-3"><i class="fas fa-clipboard-list fa-2x"></i> Sale List</h3>
                
                <a href="new_sale"><span class="btn btn-success row fileinput-button dz-clickable float-right">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr style="text-align:center">
                    ...
                    <td>{{$item->saledate}}</td>
                    <td>{{$item->saleqty}}</td>
                    <td>{{$item->saleprice}} <i class="fas fa-rupee-sign"></i></td>
                    ...
                    <td> 
                        ...
                        <a href="delete_sale/{{$item->saleinvoiceno}}" class="btn bg-danger btn-sm"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
