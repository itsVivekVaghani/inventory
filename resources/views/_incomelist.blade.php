  ...
  <div class="content-wrapper">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title col-m-3"><i class="fas fa-chart-line fa-2x"></i>Payment Income Report</h3>   
              </div>
              ...
              <h4>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>{{$item->ireceiveamount}}</td>
                    <td>{{$item->idueamount}}</td>
                    <td>{{$item->itotalamount}}</td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
