                                    ...
                                    <tbody id="addPurchaseItem">
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input type="number" name="prate"  id="purchase_rate"  class="form-control price_item1 text-right prc" placeholder="0.00" value="" tabindex="8" readonly>
                                            </td>
                                            <td class="text-right">
