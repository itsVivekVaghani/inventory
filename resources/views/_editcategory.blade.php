          ...
          <form class="form-horizontal" method="post" action="/edit_category" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group row">
                  <label for="category_id" class="col-sm-2 text-right col-form-label">Category ID :</label>
                  <div class="col-sm-4">
                      <input type="text" name="cid" class="form-control" value="{{$data->categoryid}}" readonly>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                      <input type="text" name="cname" class="form-control" id="category_name" placeholder="Category Name" value="{{$data->categoryname}}" required>
                  </div>
                </div>
